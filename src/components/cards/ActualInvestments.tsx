...
const ActualSavings: Component<{
  ...
  // Define the JSX...
  return (
    <div class="transition-shadow ease-in duration-300 h-full rounded-lg px-6 py-4 bg-cyan-400 flex flex-col justify-between items-end text-right md:px-8 md:py-6 hover:shadow-lg">
      ...
      {/* Percentage saved */}
      <p class="text-6xl text-cyan-100 tracking-tighter font-extrabold md:text-6xl">
