...
const TransactionDialog: Component = () => {
  ...
  return (
    <>
      {/* Trigger */}
      <button
        class="transition-all ease-in w-14 h-14 rounded-full bg-gray-500 text-gray-50 text-sm md:w-auto md:h-auto md:px-6 md:py-2 md:rounded-md md:text-base hover:shadow-lg"
          ...
          <footer>
            <menu class="border-t px-5 py-3 flex justify-between">
              ...
              <button
                type="submit"
                value="confirm"
                class="rounded-md px-5 py-2 bg-gray-500 text-sm text-gray-50 font-medium tracking-tight"
              >
                Confirm
              </button>
            </menu>
