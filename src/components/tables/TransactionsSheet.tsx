  ...
  return (
    <ul class="flex flex-col gap-2">
      <For each={props.transactions}>
        {(transaction) => (
          <li class="transition-colors cursor-pointer rounded-md px-5 py-4 bg-teal-100 grid grid-cols-5 gap-4 items-center text-teal-700 tracking-tighter md:px-8 md:grid-cols-12 hover:bg-teal-200">
            {/* Source */}
