...
const EditProjectedCreditDialog: Component<{
  ...
  return (
    <>
      ...
      <button
        type="button"
        class="group absolute top-2 right-2 dark:hover:bg-indigo-900 rounded-full size-10 flex items-center justify-center transition"
        onClick={() => handleDialogShow()}
      >
        <span class="material-symbols-outlined transition text-indigo-500 group-hover:text-indigo-50">
          edit
        </span>
      </button>
